...
import com.space.spacecraft.CargoSpacecraft;
import com.space.spacecraft.Shuttle;
import com.space.spacecraft.Stealth;
 ...
 * (метод вернул false) выводим сообщение «Предстартовая проверка провалена».
...
public class Run {
    public static void main(String[] args) throws InterruptedException {
        ...
        CargoSpacecraft cargoSpacecraft = new CargoSpacecraft();
        Stealth stealth = new Stealth();
        spacePort.getLaunch(shuttle);
        spacePort.getLaunch(cargoSpacecraft);
        spacePort.getLaunch(stealth);
